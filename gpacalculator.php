...
<html lang="en">
	<head>
		<title>FAQ Project Calculator</title>
...
if ( $_REQUEST['submit'] ) {
	...
	for ( $i = 1; $i <= $_REQUEST['numberofclasses']; ++$i ) {
		...
		if ( $dividendpregpa > 100 ) {
			echo "<div class=\"alert alert-warning\">Grades higher than 100 will be set to just 100.</div>";
			$dividendpregpa = 100;
		}
		if ( $dividendpregpa < 0 ) {
			echo "<div class=\"alert alert-warning\">Grades lower than 0 will be set to just 0.</div>";
			$dividendpregpa = 0;
		}
